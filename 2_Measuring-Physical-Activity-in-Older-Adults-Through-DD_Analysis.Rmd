---
title: "Replication Code: Data Donation as a Method to Measure Physical Activity in Older Adults: Cross-Sectional Web Survey Assessing Consent Rates, Donation Success, and Bias"
subtitle: "Keusch et al. (2025). Journal of Medical Internet Research. 27:e69799"
date: "2025-09-26"
output:
  html_document:
    df_print: paged
...
level_changes_bias <- c(
  ...
  "income:EUR 1000 or less" = "€1000 or less",
  "income:EUR 1001 to EUR 1500" = "€1001 to €1500",
  "income:EUR 1501 to EUR 2000" = "€1501 to €2000",
  "income:EUR 2001 to EUR 2500" = "€2001 to €2500",
  "income:EUR 2501 to EUR 3000" = "€2501 to €3000",
  "income:More than EUR 3000" = "More than €3000",
...
#### Add a font (Arial is fine)
font_add("Arial", "C:/Windows/Fonts/arial.ttf")
showtext_auto()

#### Customize minus formatter
...
bias %>%
  ...
  geom_point(size = 1) +
  geom_errorbarh(aes(xmin = CI_low, xmax = CI_up), height = 0.2, linewidth = 0.3) +  
  geom_vline(xintercept = 0, linetype = "dashed", color = "red") +
  scale_x_continuous(limits = c(-31, 30),
                     labels = minus_formatter) +
  theme_classic(base_size = 8,
                base_family = "Arial") +
  theme(
...
bias %>%
  ...
  ggplot(aes(x = bias, y = fct_rev(item))) +
  geom_point(size = 1) +
  geom_errorbarh(aes(xmin = CI_low, xmax = CI_up), linewidth = 0.3, height = 0.2) +
  geom_vline(xintercept = 0, linetype = "dashed", color = "red") +
